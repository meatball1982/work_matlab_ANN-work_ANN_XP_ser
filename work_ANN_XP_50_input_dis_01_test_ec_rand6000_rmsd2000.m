...
%% outline
% %%%%%%%%%%%%%%%%%%%
% random choose 6000 ser from 10^5. plus rmsd choose 2000 ser
...
% load the 2000 rmsd ser
dat_in_part02 = load('../data/ANN_input_out_file_tr/ANN_input_dis.txt');
dat_En_part02 = load('../data/ANN_input_out_file_tr/ANN_uhf_en.txt');
dat_Ch_part02_line = load('../data/ANN_input_out_file_tr/ANN_uhf_ch_mull.txt');
dat_Ch_part02 =reshape(dat_Ch_part02_line,n_atom,[])';

dat_in = [dat_in_part01;dat_in_part02];
dat_En = [dat_En_part01;dat_En_part02];
dat_Ch = [dat_Ch_part01;dat_Ch_part02];
...
%         t_03_ch=toc;
%         fi_na=['../res_data/ch/ch_atom_dis_rand_6000_rmsd2k/Mat_atom_dis_rand6000_rmsd2k_trper',...

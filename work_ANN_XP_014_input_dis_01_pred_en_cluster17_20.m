...
% dat_in_part02=[]; dat_En_part02=[]; dat_Ch_part02=[];
% 
...
% end
% 
% clear Ch_tm_li in_tm En_tm Ch_tm
% 
% % load errifx01 data
...
% 
% clear dat_Ch_part03_line
% 
% % load cluster data
% dat_in_part04=[]; dat_En_part04=[]; dat_Ch_part04=[];
% 
...
%     dat_path_sub=[mat2str(i),'ser/'];
%     in_tm    = load([dat_path,dat_path_sub,'ANN_in_dis.txt']);
%     En_tm    = load([dat_path,dat_path_sub,'ANN_HF_en_',     mat2str(i),'ser_clu.txt']);
%     Ch_tm_li = load([dat_path,dat_path_sub,'ANN_HF_ch_mull_',mat2str(i),'ser_clu.txt']);
%     Ch_tm =reshape(Ch_tm_li,n_atom,[])';
% 
%     dat_in_part04=[dat_in_part04;in_tm];
%     dat_En_part04=[dat_En_part04;En_tm];
%     dat_Ch_part04=[dat_Ch_part04;Ch_tm];
% 
% end
% clear Ch_tm_li in_tm En_tm Ch_tm
% 
% dat_in = [dat_in_part01;dat_in_part02;dat_in_part03;dat_in_part04;];
% dat_En = [dat_En_part01;dat_En_part02;dat_En_part03;dat_En_part04;];
% dat_Ch = [dat_Ch_part01;dat_Ch_part02;dat_Ch_part03;dat_Ch_part04;];
% 
% 
% % clear in_tm En_tm Ch_tm Ch_tm_li
% clear dat_in_part01 dat_En_part01  dat_Ch_part01
% clear dat_in_part02 dat_En_part02  dat_Ch_part02
% clear dat_in_part03 dat_En_part03  dat_Ch_part03
% clear dat_in_part04 dat_En_part04  dat_Ch_part04
% 
% 
% save Mat_014_cluster.mat n_inp n_atom dat_in dat_En dat_Ch str_del
 

load Mat_014_cluster.mat
...
%     dat_Ch_mu_si=dat_Ch(ind_sim,:);
    ...
    for ite=1:n_ite
        ...
        t_en=toc;
        fi_na=['../res_data/en/en_atom_dis_cluster/Mat_atom_dis_cluster_trper',...
...
%         t_03_ch=toc;
%         fi_na=['../res_data/ch/ch_atom_dis_cluster/Mat_atom_dis_cluster_trper',...

...
% atom dis as the ANN input


%% en  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% clf
% fi_na=['../res_data/en/en_atom_dis/Mat_atom_dis_8000.mat'];
% 
% load(fi_na);
...
% for i=1:8
    ...
    fi_na=['../res_data/en/en_atom_dis/Mat_atom_dis_',...
    ...
    fi_na=['../imgs/en/02atom_dis/cong_tr/fig_en_',mat2str(nnt_epochs_en),'_congress'];
    ...
    fi_na=['../imgs/en/02atom_dis/cong_si/fig_en_',mat2str(nnt_epochs_en),'_congress'];
    fun_work_li_035_myfig_out(h,fi_na,3); 

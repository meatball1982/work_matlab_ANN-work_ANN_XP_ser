...
na_ann_train='Mat_atom_dis_errfix01_trper100_ite_8000_rep_1_del_0.mat';
...
for k=1:length(na_list)
    ...
    na_fi_store=['../res_data/Pre_res_data/errfix01/Mat_',...
        na_ser,'errfix01_ite_',mat2str(nnt_epochs_en),...
    ...
    fi_na=['../imgs/en/08en_atom_dis_errfix01/cong_pr/fig_en_',...
        na_ser,'pr_congress'];

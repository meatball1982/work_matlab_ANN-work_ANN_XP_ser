...
% for i=1:20
%     tic
%     nnt_epochs_ch = 1000 + 1000 * i;
%     % nnt_epochs_ch = 2 + 1 * i;
%     nnt_goal_ch= 1e-5;                   % net parameters
%     % nnt_epochs_ch = 5; nnt_goal_ch= 1e-4;                   % net parameters
%     net_ch = fun_gen_nnt(in_tr_01,n_atom*2, n_atom);          % mod : 21-Nov-2013 10:29:30. hidden is 23*2.
...
%     t_03_ch=toc;
%     fi_na=['../res_data/ch/ch_rand_chose/Mat_rand_chose_',...
%                                      mat2str(nnt_epochs_ch),'_rep',mat2str(m),'.mat'];
%     save(fi_na);
% end
...
for k=1:20
    ...
    for i=1:3
        ...
        fi_na=['../res_data/fs/fs_rand_chose/Mat_rand_chose_',mat2str(nnt_epochs),'_rep',mat2str(m),'.mat'];
        save(fi_na);
    end
end

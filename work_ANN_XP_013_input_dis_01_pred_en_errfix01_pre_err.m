...
% load errifx01 data
dat_in = load('../data/ANN_input_out_file_errfix01/ANN_in_dis.txt');
dat_En = load('../data/ANN_input_out_file_errfix01/ANN_HF_en_errfix01.txt');
dat_Ch_line = load('../data/ANN_input_out_file_errfix01/ANN_HF_ch_mull_errfix01.txt');
dat_Ch =reshape(dat_Ch_line,n_atom,[])';


dat_in_pr=dat_in(end-5:end,:);
dat_En_pr=dat_En(end-5:end,:);
...
%             tr_rat_str,'_ite_',mat2str(nnt_epochs_en),'_rep_',mat2str(i),'_del_0.mat'];
%         save(fi_na);
%     
